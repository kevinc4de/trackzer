...
export const ReportPhone: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
        <div className="text-center mb-4">
          <h1 className="text-2xl font-bold text-gray-900">Signalement de téléphone</h1>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="text-center mb-4">
        <h1 className="text-2xl font-bold text-gray-900">Signaler un téléphone perdu ou volé</h1>
        <p className="text-gray-600">Formulaire de signalement - Cameroun</p>
      </div>
